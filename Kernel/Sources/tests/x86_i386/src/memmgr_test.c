...
/************************** TEST PAGES ****************************************/
    ...
    OS_RETURN_E error;
    error = free_kpages((void*)0xe0382000, 2);
    ...
    kernel_printf("[TESTMODE] Wanted error: %d\n", error);
    kernel_printf("[TESTMODE] ");
    perror(error);
    kernel_printf("\n");
    ...
    error = free_kpages((void*)0x0382000, 2);
    cursor = paging_get_free_pages()->head;
    while(cursor)
    {
        range = (mem_range_t*)cursor->data;
...
/************************** TEST FRAMES ***************************************/
    ...
    error = free_kframes((void*)0xe0382000, 2);
    ...
    error = free_kpages((void*)0x000f0000, 2);
    cursor = paging_get_free_frames()->head;
    while(cursor)
    {
        range = (mem_range_t*)cursor->data;
