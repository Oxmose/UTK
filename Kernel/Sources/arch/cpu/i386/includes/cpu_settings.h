...
#define K_THREAD_INIT_EFLAGS 0x202 /* INT | PARITY */
/** @brief Thread's initial EAX register value. */
#define K_THREAD_INIT_EAX    0
/** @brief Thread's initial EBX register value. */
#define K_THREAD_INIT_EBX    0
/** @brief Thread's initial ECX register value. */
#define K_THREAD_INIT_ECX    0
/** @brief Thread's initial EDX register value. */
#define K_THREAD_INIT_EDX    0
/** @brief Thread's initial ESI register value. */
#define K_THREAD_INIT_ESI    0
/** @brief Thread's initial EDI register value. */
#define K_THREAD_INIT_EDI    0
/** @brief Thread's initial CS register value. */
#define K_THREAD_INIT_CS     THREAD_KERNEL_CS
/** @brief Thread's initial SS register value. */
#define K_THREAD_INIT_SS     THREAD_KERNEL_DS
/** @brief Thread's initial DS register value. */
#define K_THREAD_INIT_DS     THREAD_KERNEL_DS
/** @brief Thread's initial ES register value. */
#define K_THREAD_INIT_ES     THREAD_KERNEL_DS
/** @brief Thread's initial FS register value. */
#define K_THREAD_INIT_FS     THREAD_KERNEL_DS
/** @brief Thread's initial GS register value. */
#define K_THREAD_INIT_GS     THREAD_KERNEL_DS

/** @brief Thread's initial EFLAGS register value. */
#define U_THREAD_INIT_EFLAGS 0x202 /* INT | PARITY */
/** @brief Thread's initial EAX register value. */
#define U_THREAD_INIT_EAX    0
/** @brief Thread's initial EBX register value. */
#define U_THREAD_INIT_EBX    0
/** @brief Thread's initial ECX register value. */
#define U_THREAD_INIT_ECX    0
/** @brief Thread's initial EDX register value. */
#define U_THREAD_INIT_EDX    0
/** @brief Thread's initial ESI register value. */
#define U_THREAD_INIT_ESI    0
/** @brief Thread's initial EDI register value. */
#define U_THREAD_INIT_EDI    0
/** @brief Thread's initial CS register value. */
#define U_THREAD_INIT_CS     THREAD_KERNEL_CS
/** @brief Thread's initial SS register value. */
#define U_THREAD_INIT_SS     THREAD_KERNEL_DS
/** @brief Thread's initial DS register value. */
#define U_THREAD_INIT_DS     THREAD_KERNEL_DS
/** @brief Thread's initial ES register value. */
#define U_THREAD_INIT_ES     THREAD_KERNEL_DS
/** @brief Thread's initial FS register value. */
#define U_THREAD_INIT_FS     THREAD_KERNEL_DS
/** @brief Thread's initial GS register value. */
#define U_THREAD_INIT_GS     THREAD_KERNEL_DS
