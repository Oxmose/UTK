...
/**
 * @brief Defines uhashtable_alloc_t type as a shorcut for struct 
 * uhashtable_alloc.
 */
typedef struct uhashtable_alloc uhashtable_alloc_t;

/** @brief Unsigned hash table entry structure. */
struct uhashtable_entry
{
...
/**
 * @brief Defines uhashtable_entry_t type as a shorcut for struct 
 * uhashtable_entry.
 */
typedef struct uhashtable_entry uhashtable_entry_t;
...
/**
 * @brief Defines uhashtable_t type as a shorcut for struct uhashtable.
 */
typedef struct uhashtable uhashtable_t;
