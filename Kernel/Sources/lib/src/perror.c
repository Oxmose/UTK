...
int perror(const int error)
{
    switch(error)
    {
        ...
        case OS_ERR_NO_SUCH_LAPIC_ID:
            ...
            break;
        case OS_ERR_NO_SUCH_UART_BAUDRATE:
            printf("UART baudrate not supported");
            break;
        case OS_ERR_NO_SUCH_UART_PARITY:
            printf("UART parity not supported");
            break;
...
divide your request into mulstiple read/write");
        ...
        case OS_ERR_MEMORY_NOT_MAPPED:
            ...
            break;
        case OS_ERR_SMBIOS_NOT_FOUND:
            printf("SMBIOS structures not found");
            break;
        case OS_ERR_BAD_HANDLER:
            printf("Bad interrupt handler");
            break;
